  ...
  return(
    ...
    viewHeight="70vh">
      <Section>
        ...
        <div className="body">
          <Themed.p>
          Manage users securely and efficiently with identity management. Smart Pro Technologies establishes new clients with the top identity providers such as Microsoft & Google to enable their workforce. Our team of certified professionals will integrate existing services ranging from softwares to entire on-prem infrastructure. No project is the same and our approach is tailored to each customers needs and wants. Reach out to us to see how we can help you.
          </Themed.p>
        </div>
        <Content>
          <Row>
