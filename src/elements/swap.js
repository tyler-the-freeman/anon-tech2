/*! swap.js | Copyright © 2011-2021 CallRail Inc. | License: www.callrail.com/legal */
...
!(function () {
  ...
  (CallTrkSwap.prototype.run = function () {
    (this.referrer = this.getReferrer()),
      ...
      (this.referrer_key = CallTrkSwap.getReferrerKey(
        this.referrer,
        this.landing
      )),
  ...
  (CallTrkSwap.perfData = function () {
    ...
    if (((CallTrkSwap._perfData = {}), window.performance))
      try {
  ...
  CallTrkSwap.perfData(),
  (CallTrkSwap.documentReferrer = function () {
  ...
  (CallTrkSwap.nearestTLD = function () {
    ...
    for (var t = r.length - 1; t >= 0; --t) {
      ...
      if (
        (this.createCookie("calltrk_nearest_tld", n, 3600, n),
        e !== this.documentCookie())
      )
        return (
          this.eraseCookie("calltrk_nearest_tld", n),
  ...
  (CallTrkSwap.createCookie = function (e, a, r, t) {
    ...
    this.crossSubdomain() && !1 !== t && !t && (t = this.nearestTLD()),
      t && (l += "; domain=" + t);
    var o = this.getItem(e);
    return (
      o && o == a
        ? this.documentCookie(l)
        : this.hasCookie(l)
        ? this.setItem(e, a)
        : (this.setItem(e, a), this.documentCookie(l)),
      l
    );
  }),
  (CallTrkSwap.crDeleteOldCookies = function () {
    this.eraseCookie("calltrk_referrer"),
      this.eraseCookie("calltrk_landing"),
      this.eraseCookie("calltrk_session_id");
    ...
    if (e)
      for (var a = 0; a < e.length; ++a) {
        var r = e[a],
          t = /[0-9]+/g,
          n = r.match(t)[0];
        this.eraseCookie("calltrk_session_id_" + n),
          this.eraseCookie("calltrk_session_swap_numbers_" + n);
      }
  }),
  ...
  (CallTrkSwap.readCookie = function (e) {
    ...
    return r.length <= 1 && !a
      ? (this.setItem(e, r[0]), r[0] || null)
      : a
      ? (0 === r.length && this.createCookie(e, a), a)
      : (this.crossSubdomain()
          ? this.eraseCookie(e, !1)
          : this.eraseCookie(e, this.nearestTLD()),
        (r = this.cookieValues(e)),
        r[0] || null);
  }),
  (CallTrkSwap.cookieValues = function (e) {
    for (
      var a = e + "=", r = this.documentCookie().split(";"), t = [], n = 0;
      n < r.length;
      n++
    ) {
  ...
  (CallTrkSwap.prototype.applyTrumpSources = function () {
    if (this.trump_sources) {
      var e = CallTrkSwap.getReferrerKey(
        CallTrkSwap.documentReferrer(),
        CallTrkSwap.documentURL()
      );
      CallTrkSwap.contains(["google_paid", "yahoo_paid", "bing_paid"], e) &&
        (CallTrkSwap.crDeleteOldCookies(),
        delete CallTrkSwap._referrer,
        delete CallTrkSwap._landing,
        (CallTrkSwap._referrerAndLandingCookiesCreated = !1),
        (this.referrer = CallTrkSwap.documentReferrer()),
        (this.landing = CallTrkSwap.documentURL()),
        this.createReferrerAndLandingCookies(),
        (this.referrer_key = e));
    }
  }),
  (CallTrkSwap.prototype.applyTrumpLandingPage = function () {
    ...
    if (this.trump_landing_param) {
      e(this.trump_landing_page_param) &&
        (CallTrkSwap.crDeleteOldCookies(),
        delete CallTrkSwap._referrer,
        delete CallTrkSwap._landing,
        (CallTrkSwap._referrerAndLandingCookiesCreated = !1),
  ...
  (CallTrkSwap.prototype.createReferrerAndLandingCookies = function () {
    CallTrkSwap._referrerAndLandingCookiesCreated ||
      (CallTrkSwap.hasWordpressCookies()
        ? this.postWordpressCookies(this.referrer, this.landing)
        : (CallTrkSwap.createCookie("calltrk_referrer", this.referrer),
          CallTrkSwap.createCookie("calltrk_landing", this.landing)),
      (CallTrkSwap._referrerAndLandingCookiesCreated = !0));
  }),
  ...
  (CallTrkSwap.getReferrerKey = function (e, a) {
    ...
    if (a.match(/ndclid=/i)) r = "nextdoor_paid";
    else if (e.match(/doubleclick/i) || a.match(/dclid=|wbraid=|gbraid=/i))
      r = "google_paid";
      ...
      r = a.match(/gclid=/i)
        ? e.match(/(\/|\.)youtube\./i) || a.match(/utm_source=.*youtube.*/i)
          ? "youtube_paid"
          : a.match(/msclkid=/i)
          ? "bing_paid"
          : "google_paid"
        ...
        ? e.match(/(\/|\.)duckduckgo\./i) ||
          a.match(/utm_source=.*duckduckgo.*/i)
          ? "duckduckgo_paid"
          : "bing_paid"
        : e.match(/(\/|\.)bing\./i) || a.match(/utm_source=.*bing.*/i)
        ? a.match(t) || a.match(/msclkid=/i)
          ? "bing_paid"
          : "bing_organic"
        : e.match(/msn\.com/i)
        ? "bing_paid"
        ...
        ? a.match(t)
          ...
          : "yahoo_organic"
        : a.match(/fb_ad_id=/i)
        ? e.match(/(\/|\.)instagram\./i) || a.match(/utm_source=.*instagram.*/i)
          ? "instagram_paid"
          : "facebook_paid"
        : a.match(/(fbclid=)/i) && e.match(/(\/|\.)instagram\./i)
        ? a.match(t)
          ? "instagram_paid"
          : "instagram_organic"
        : e.match(/(\/|\.)facebook\./i) ||
          a.match(/(fbclid=|utm_source=.*facebook.*)/i)
        ? a.match(t)
          ? "facebook_paid"
          : "facebook_organic"
        : e.match(/(\/|\.)instagram\./i) || a.match(/utm_source=.*instagram.*/i)
        ...
        ? a.match(t)
          ? "duckduckgo_paid"
          : "duckduckgo_organic"
        : e.match(/(\/|\.)nextdoor\./i) || a.match(/utm_source=.*nextdoor.*/i)
        ? a.match(t)
          ? "nextdoor_paid"
          : "nextdoor_organic"
        : e.match(/(\/|\.)linkedin\./i) || a.match(/utm_source=.*linkedin.*/i)
        ? a.match(t)
          ? "linkedin_paid"
          : "linkedin_organic"
        : e.match(/(\/|\.)twitter\./i) || a.match(/utm_source=.*twitter.*/i)
        ? a.match(t)
          ? "twitter_paid"
          : "twitter_organic"
        : e.match(/(\/|\.)pinterest\./i) || a.match(/utm_source=.*pinterest.*/i)
        ? a.match(t)
          ? "pinterest_paid"
          : "pinterest_organic"
        : e.match(/(\/|\.)spotify\./i) || a.match(/utm_source=.*spotify.*/i)
        ? a.match(t)
          ? "spotify_paid"
          : "spotify_organic"
        : e.match(/(\/|\.)yelp\./i) || a.match(/utm_source=.*yelp.*/i)
        ? a.match(t) ||
          a.match(/utm_(medium|source|campaign)=yelp_ad/i) ||
          a.match(/campaign_code=yelp_ad/i)
          ? "yelp_paid"
          : "yelp_organic"
        : e.match(/(\/|\.)youtube\./i) || a.match(/utm_source=.*youtube.*/i)
        ? a.match(t)
          ...
          : "youtube_organic"
        : "direct" === e
        ? a.match(t) && a.match(/utm_source=.*google.*/i)
          ? "google_paid"
          : "direct"
        : CallTrkSwap.getReferrerDomain(e);
    return r;
  }),
  ...
  (CallTrkSwap.domEach = function (e, a) {
    for (var r = document.querySelectorAll(e), t = 0; t < r.length; t++)
      a(r[t]);
  }),
  (CallTrkSwap.hasClass = function (e, a) {
    return e.classList
      ? e.classList.contains(a)
      : new RegExp("(^| )" + a + "( |$)", "gi").test(e.className);
  }),
  ...
  (CallTrkSwap.CHAR_SEP = "([-. " + String.fromCharCode(160) + "]?)"),
  (CallTrkSwap.NUM_REGEX = new RegExp(
    "(\\(?)\\d{3}(\\))?" +
      CallTrkSwap.CHAR_SEP +
      "\\d{3}" +
      CallTrkSwap.CHAR_SEP +
      "\\d{4}\\b",
    "g"
  )),
  (CallTrkSwap.stringTargets = function (e) {
    return (e && e.match(this.NUM_REGEX)) || [];
  }),
  (CallTrkSwap.INTL_NUM_REGEX =
    /[(+]?[(+]?(?:[\d][ \-.()\u202F\u00A0]{0,2}){8,21}[\d]/g),
  (CallTrkSwap.intlStringTargets = function (e) {
    return (e && e.match(this.INTL_NUM_REGEX)) || [];
  }),
  (CallTrkSwap.recurseDOM = function (e, a, r) {
    for (var t = r || e, n = 1; t; ) {
      var i = null;
      !1 !== a(t) && t.nodeType === n && (i = t.firstChild),
        t.nextSibling && t !== e && CallTrkSwap.recurseDOM(e, a, t.nextSibling),
        (t = i);
    }
  }),
  (CallTrkSwap.traverseDOM = function (e, a) {
    ...
    this.domEach(".cr_image, .cr_image *", function (e) {
      ...
      CallTrkSwap.recurseDOM(a, function (a) {
        switch (a.nodeType) {
          case 1:
            if ("SCRIPT" === a.tagName || a.hasAttribute("data-calltrk-noswap"))
              return !1;
            l(r, a), o(a);
            break;
          case 3:
            var t = e(a.nodeValue);
            null != t &&
              (CallTrkSwap._isDebug &&
                (a.parentNode.className += " calltrk-swap-occurred"),
              (a.nodeValue = t));
        }
      });
  }),
  (CallTrkSwap.domTargets = function (e) {
    var a,
      ...
      n = /\D/g;
    return (
      this.traverseDOM(function (e) {
        a = CallTrkSwap.stringTargets(e);
        for (var i = 0; i < a.length; i++)
          (r = a[i].replace(n, "")),
            r.length > 10 && (r = r.slice(r.length - 10)),
            -1 === CallTrkSwap.indexOf(t, r) && t.push(r);
        CallTrk.eachNamespace(function (ns) {
  ...
  (CallTrkSwap.replacementForPlainText = function (e, a) {
    ...
    return (
      (e = e.replace("###phone###", i)),
      (e = e.replace("###phone-dashes###", l)),
      (e = e.replace("###phone-dots###", o))
    );
  }),
  (CallTrkSwap.prototype.getGoogleContentExperimentCookies = function (e) {
    ...
    var a;
    if (
      ((a = CallTrkSwap.readCookie("calltrk_google_experiments")
        ? CallTrkSwap.readCookie("calltrk_google_experiments")
        : ""),
      this.getURLParameter("utm_expid"))
    ) {
      var r = this.getURLParameter("utm_expid"),
        t = this.getHostnameAndPath(),
        n = r + "," + t;
      a.indexOf(n) < 0 && (a = "" !== a ? a + "|" + n : n),
        CallTrkSwap.createCookie("calltrk_google_experiments", a);
    }
  ...
  (CallTrkSwap.visibleParent = function () {
    try {
      if (
        ...
        window.self.document === window.top.document
      )
        return !1;
    } catch (e) {
      return !1;
  ...
  (CallTrkSwap.prototype.getSecondScript = function (e, a, r) {
    ...
    for (var o in e) {
      var s = e[o] || "",
        p = s;
      "object" == typeof s && (p = s.national_string),
        p || (l[o] = null),
        t.swaps.push(o + "=" + p);
    }
    if (
      (Object.keys(l).length && this.mergeUnassignedSwaps(l),
  ...
  (CallTrkSwap.parseCookieResponse = function (e, a, r) {
    204 !== e &&
      ((window.crwpVer = 0),
      CallTrkSwap.createCookie("calltrk_referrer", a),
      CallTrkSwap.createCookie("calltrk_landing", r));
  }),
  (CallTrkSwap._debugEnabled = function () {
    return !!CallTrkSwap.windowLocation().href.match(/crl?dbg/);
  }),
  (CallTrkSwap._isDebug = CallTrkSwap._debugEnabled()),
  (CallTrkSwap._log = []),
  (CallTrkSwap._unassigns = []),
  (CallTrkSwap.log = function (e, a) {
    this._isDebug &&
      (a || ((a = e), (e = "swap")), this._log.push(e.toString() + ": " + a));
  }),
  ...
  (CallTrkSwap.parseSessionSwap = function (e) {
    !0 === e.domless
      ...
      CallTrkSwap.makePhoneSwapVisible(),
      !0 === e.integration_retry &&
        CallTrkSwap.integrationRetry(e.integration_retries);
  }),
  (CallTrkSwap.startSessionSwap = function (e, a) {
    ...
    for (var i in CallTrk._namespaceObjs)
      n = CallTrk._namespaceObjs[i].swapString(n);
    if (
      (n !== document.title && (document.title = n),
      this.traverseDOM(function (e, a) {
        var n = e;
        CallTrkSwap._isDebug && CallTrkSwap.foundTargets.push(e),
          r.forEach(function (e) {
            for (var r in t[e])
              n = CallTrkSwap.scanString(n, r, t[e][r], undefined, a);
          }, this);
        for (var i in CallTrk._namespaceObjs)
          n = CallTrk._namespaceObjs[i].swapString(n, a);
        if (n !== e) return n;
      }, a),
    ...
    this.firstNamespace().mutation_observer && CallTrkSwap.startObserving(),
      CallTrkSwap.makePhoneSwapVisible();
  }),
  (CallTrkSwap.adjustExactFormat = function (e) {
    var a = { advanced: {}, simple: {} };
    for (var r in e)
      if (-1 !== r.indexOf(",")) {
        var t = r.split(","),
  ...
  (CallTrkSwap.prototype.swapString = function (e, a) {
    return (
      this._storedSwapCache ||
        (this._storedSwapCache = CallTrkSwap.adjustExactFormat(
          this.getStoredSwaps()
        )),
      ["advanced", "simple"].forEach(function (r) {
  ...
  (CallTrkSwap.scanString = function (e, a, r, t, n) {
    ...
    function o(r, t) {
      ...
      if (a.slice(1) === n.slice(n.length - 8)) {
        ...
        CallTrkSwap._isDebug && (CallTrkSwap.doneSwaps[e] = r),
          (e = e.replace(i, r));
      }
      return e;
    }
    var s,
      p = t !== undefined;
    return (
      p || CallTrkSwap.isArray(r)
        ? e.indexOf(a) > -1 &&
          ((s = this.replacementForPlainText(p ? t : r[0], p ? r : r[1])),
          CallTrkSwap._isDebug && (CallTrkSwap.doneSwaps[a] = s),
          (e = e.replace(a, s)))
        : (e =
  ...
  (CallTrkSwap.findFormat = function (e, a) {
    for (var r in a) if (this.isSameFormat(e, a[r])) return r;
    return null;
  }),
  ...
  (CallTrkSwap.standardReplace = function (e, a, r) {
    if (
      (this._numberRegexCache || (this._numberRegexCache = {}),
      !this._numberRegexCache[a])
    ) {
  ...
  (CallTrkSwap.setItem = function (e, a) {
    return (
      ...
      a === undefined
        ...
        : window.localStorage.setItem(e, CallTrkSwap.jsonify(a)),
      this.getItem(e)
    );
  }),
  ...
  (CallTrkSwap.prototype.hasSessionTracker = function () {
    return (
      this.session_number_target_exists || this.session_exact_targets.length > 0
    );
  }),
    ...
    if (
      (CallTrk.eachNamespace(function (ns) {
        ns.hasSessionTracker() &&
          ((i = !0),
          (t = ns.session_poll_interval),
          (n = n || ns.session_polling));
      }),
      i)
    ) {
      for (
        var l = CallTrkSwap.domTargets(a), o = !1, s = e, p = 0;
        p < l.length;
        p++
      )
        (r[l[p]] = null),
          CallTrkSwap._isDebug && CallTrkSwap.foundTargets.push(l[p]);
      CallTrk.eachNamespace(function (ns) {
        var e = ns.checkSessionSwap(r);
        o = o || e;
      }),
        o && CallTrkSwap.startSessionSwap({}, a),
        CallTrk.eachNamespace(function (ns) {
          s = s || ns.checkUnassignedSwaps(r);
        }),
        s &&
          (CallTrkSwap.firstNamespace().getSecondScript(r, e),
          t && n && CallTrkSwap.pollInit());
    }
    this.firstNamespace().mutation_observer && CallTrkSwap.startObserving(),
  ...
  (CallTrkSwap.pollSession = function () {
    ...
    var ns = CallTrkSwap.firstNamespace(),
      e = {},
      a = Date.now(),
      r = 0.9 * ns.session_poll_interval;
    setTimeout(CallTrkSwap.pollWatch, ns.session_poll_interval),
      (CallTrkSwap.lastPoll && a - CallTrkSwap.lastPoll < r) ||
        ((CallTrkSwap.lastPoll = a),
        CallTrkSwap.isMulti() || (e.ids = CallTrkSwap.namespaceIds()),
        CallTrkSwap.getScript(CallTrkSwap.pollSessionURL(), e));
  }),
  (CallTrkSwap.pollInit = function () {
    var e = this.firstNamespace().session_poll_interval;
    this.pollInitted ||
      ((this.pollInitted = !0), setTimeout(this.pollWatch, e));
  }),
  (CallTrkSwap.pollWatch = function () {
    CallTrkSwap.addEventListener(
      document,
      "mousemove",
      CallTrkSwap.pollSession
    ),
      CallTrkSwap.addEventListener(
        document,
        "keypress",
      ...
      CallTrkSwap.addEventListener(window, "focus", CallTrkSwap.pollSession);
  }),
  (CallTrkSwap.pollUnwatch = function () {
    CallTrkSwap.removeEventListener(
      document,
      "mousemove",
      CallTrkSwap.pollSession
    ),
      ...
      CallTrkSwap.removeEventListener(window, "focus", CallTrkSwap.pollSession);
  }),
  ...
  (CallTrkSwap.getSessionID = function (e) {
    ...
    return (
      ...
      a || ((a = this.generateUUID()), this.createCookie(e, a)),
      (this._session_id = a),
      a
    );
  }),
  (CallTrkSwap.getFormCaptureCookie = function (e) {
    ...
    var a = this.readCookie(e);
    return (
      a || (a = this.generateUUID()),
      this.createCookie(e, a),
      (this._fcid = a),
      a
    );
  }),
  (CallTrkSwap.generateUUID = function () {
    ...
    return e && e.getRandomValues
      ? "10000000-1000-4000-8000-100000000000".replace(/[018]/g, function (a) {
          ...
          return (
            r ^
            (e.getRandomValues(new Uint8Array(1))[0] & (15 >> (r / 4)))
          ).toString(16);
        })
  ...
  (CallTrkSwap.startSwaps = function () {
    document.removeEventListener &&
      ...
      this.iframeAwareReady(function () {
        var e = CallTrkSwap;
        (e.doneSwaps = {}),
          (e.foundTargets = []),
          e.startSourceSwap(),
  ...
  (CallTrkSwap.startObserving = function () {
    CallTrkSwap.observer ||
      ...
      ((CallTrkSwap.observer = new MutationObserver(this.mutationCallback)),
      CallTrkSwap.observer.observe(document.body, {
        childList: !0,
        subtree: !0,
      }));
  }),
  (CallTrkSwap.stopObserving = function () {
    CallTrkSwap.observer &&
      (CallTrkSwap.observer.disconnect(), (CallTrkSwap.observer = null));
  }),
  (CallTrkSwap.mutationCallback = function (e) {
    for (
      var a = CallTrkSwap.firstNamespace().session_observer, r = !1, t = 0;
      t < e.length;
      t++
    )
      for (var n = e[t], i = 0; i < n.addedNodes.length; i++) {
        var l = n.addedNodes[i];
        CallTrkSwap.startSourceSwap(l),
          a && (r = r || CallTrkSwap.domTargets(l).length > 0);
      }
  ...
  (CallTrkSwap.prototype.buildURL = function (e, a) {
    ...
    return (
      ...
      CallTrkSwap.wpProxy() && (r = CallTrkSwap.proxyPath(r)),
      r &&
  ...
  (CallTrkSwap.indexOf = function (e, a) {
    ...
    for (var r = 0; r < e.length; r++) if (e[r] === a) return r;
    return -1;
  }),
  (CallTrkSwap.getScript = function (e, a, r) {
    ...
    (t.type = "text/javascript"),
      ...
      (e += "&" + this.param(a)),
      CallTrkSwap.wpProxy() && r && (e = this.proxyPath(e)),
      (t.src = e),
  ...
  (CallTrkSwap.startSourceSwap = function (e) {
    ...
    if (0 !== a.length) {
      ...
      if (
        (t && (document.title = t), CallTrkSwap.traverseDOM(r, e), window.Cufon)
      )
        try {
          window.Cufon.refresh();
        } catch (e) {}
  ...
  (CallTrkSwap.prototype.youTubeMatch = function (e) {
    return (
      ...
      CallTrkSwap.contains(e, "google_paid")
    );
  }),
    ...
    for (var e = [], a = 0; a < this.source_trackers.length; a++) {
      ...
      if ("all" !== r.referrer_tracking_source) {
        ...
        -1 !== this.landing.indexOf(r.landing_tracking_source)
          ? e.push(r)
          : this.hasReferrerMatch(r.referrer_keys) && e.push(r);
      } else e.push(r);
    }
    return e;
  }),
    ...
    (CallTrkSwap.prototype.getIntegrationData = function (cookieCache) {
      var ic = this.data_collection_config.cookies,
        ...
        params = {
          google_content_cookies:
            this.getGoogleContentExperimentCookies(cookieCache),
        };
      for (var reportName in ic) {
        ...
        cookieCache[cookie] !== undefined
          ...
          : ((value = CallTrkSwap.readCookie(cookie)),
      ...
      for (var reportAs in ij) {
        ...
        try {
          var rc = eval(code);
          "object" != typeof rc ||
            CallTrkSwap.isArray(rc) ||
            (rc = CallTrkSwap.param(rc)),
            (params[reportAs] = rc);
        } catch (e) {}
      }
      return params;
          ...
          e.hasOwnProperty(t) &&
            ...
            (r &&
              (t =
                r +
                "[" +
                (this.isArray(e) && !this.isArray(e[0]) ? "" : t) +
                "]"),
            "object" != typeof n
              ? a.push(encodeURIComponent(t) + "=" + encodeURIComponent(n))
              : this.param(n, a, t));
        }
      ...
      (CallTrkSwap.integrationRetry = function (e) {
        ...
        CallTrkSwap.isEmptyObject(a) ||
          ((a.uuid = CallTrkSwap.getSessionID()),
          CallTrkSwap.isMulti() || (a.ids = e),
          CallTrkSwap.getScript(r.icapURL(), a));
      }),
    ...
    (CallTrkSwap.prototype.getWidgetScripts = function () {
      function e(e) {
        a.endpoints[e] &&
          ...
          (CallTrkSwap.getScript(a.endpoints[e], {}, !0),
          CallTrk.appendedScripts.push(e));
      }
      var a = this;
      CallTrkSwap.documentReady(function () {
        a.endpoints.chat && CallTrkSwap.getScript(a.endpoints.chat, {}, !0),
          a.endpoints.contact &&
            !a.endpoints.chat &&
            CallTrkSwap.getScript(a.endpoints.contact, {}, !0),
          a.endpoints.external_chats &&
            CallTrkSwap.getScript(a.endpoints.external_chats, {}, !0),
          e("custom_forms"),
          e("external_forms");
      });
    }),
  ...
  (function () {
    ...
    function t() {
      ...
      for (
        var a = CallTrkSwap.matchingSourceTrackers(), t = 0;
        t < a.length;
        t++
      )
    ...
    window.CallTrk = window.CallTrk || {
      ...
      appendedScripts: [],
      swap: function (e) {
        (CallTrkSwap.doneSwaps = {}),
          (CallTrkSwap.foundTargets = []),
          (e = e || document.body),
      ...
      getSwapNumbers: function (e, a) {
        ...
        for (
          var r = t(),
            n = window.CallTrk._namespaces[0],
            ns = window.CallTrk._namespaceObjs[n],
            i = {},
            l = 0;
          l < e.length;
          l++
          ...
          var o = e[l];
          r[o] &&
            ((i[o] = CallTrkSwap.defaultNumberFormat(r[o])), e.splice(l--, 1));
        }
        return (
          0 === e.length
            ? a(i)
...
!(function () {
  new CallTrkSwap({
    ...
    access_key: "a0d58eeb0d9f741826c0",
    form_capture_config: {
      enabled: !0,
      url_scope: "all",
      urls: [],
    ...
    endpoints: {
      multiswap_session:
        "//js.callrail.com/group/0/a0d58eeb0d9f741826c0/12/swap_session.js",
      integration_retry:
        "//js.callrail.com/group/0/a0d58eeb0d9f741826c0/12/icap.js",
      form_capture:
        "//app.callrail.com/companies/221658841/a0d58eeb0d9f741826c0/12/form_capture.js",
      poll_session:
        "//js.callrail.com/group/0/a0d58eeb0d9f741826c0/$uuid/poll.js",
      cr_form: "//js.callrail.com/forms/$formid",
      external_forms: "//js.callrail.com/companies/221658841/external_forms.js",
    },
